  ...
  function Coder() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "run", function () {
      fetch('http://run.kfcoding.com', {
        method: 'POST',
        body: JSON.stringify({
          language: _this.props.instance.props.get('language'),
          code: _this.props.instance.props.get('content')
        })
      }).then(function (res) {
        return res.json();
      }).then(function (data) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateCode", function (code) {
      _this.props.instance.setProp('content', code);
    });
  ...
  _createClass(Coder, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_reactSplitPane.default, {
        ...
        value: instance.props.get('content'),
